...
**Development has moved to `github.com/SmileyChris/django-countries <https://github.com/SmileyChris/django-countries>`_ **

Please use that repository for issue tracking (and forking).
The same Transifex repository is being used for translations.
